...
sqls = sqls & "RIFA, ST_RIFA, st_condicion "
...
<div class="col-sm-8 col-md-8 col-md-offset-2 col-sm-offset-2">				
<form  class="form-horizontal" method="POST" action="grabacita1.asp" onsubmit="return validar();"">
...
<table class="table">
	<tr>
		...
		<% Do Until Rs1.EOF %>
    <tr>
     	<td style="width: 50px;"><strong> <%= Rs1(6) %></strong></td>
