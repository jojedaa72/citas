...
<body>
	<TABLE border='1' cellpadding = '4' cellspacing = '2'>
		...
		%>
			<TR>
				<%
				sSql = " select r.asiento, r.familia, u.ds_usuario, u.ds_familia, u.fe_ulting, r.final from RESERVA r, usuario u where r.familia = u.ds_usuario and r.familia = '" & Rs("familia") & "' and r.estado = '1' "
