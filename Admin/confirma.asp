...
sSql = "select * from reserva where asiento = '" & asiento & "'  "
'sSql = "select * from reserva where asiento = '" & asiento & "' and familia = '" & family & "' "
Rs.Open sSql, Cn
If NOT Rs.EOF Then
...
<body>
<form name="frmAlumnos" method="post" action="graba.asp">
<!-- Campos tipo HIDDEN -->
