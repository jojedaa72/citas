...
sSql = " select asiento, pago from RESERVA where estado = '1' and familia = '" & Usuario & "' "
Rs.Open sSql, Cn


ssSql = "update reserva set final = '1'" 
...
<table style="width: 640px" align="center" class="auto-style1">
	...
	<TR>
	 ...
	 <span class="auto-style19">** VIERNES 22 **</span></strong></td>
	</TR>
	<br>
	<TR>
